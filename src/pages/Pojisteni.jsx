      ...
      {showInsuranceTypes && (
        <>
          ...
          <div className="insurance-police-holder-box">
            ...
            <p>
              {insuranceTypes.type2} je druhem pojištění osob, který se zaměřuje
              na poskytnutí finanční ochrany v případě smrti pojištěné osoby.
              Toto pojištění může také sloužit jako forma investice a úspor,
              které mohou být využity v budoucnosti nebo předávány dědicům.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            <span>
            ...
            <p>
              ...
              cestováním. Toto pojištění vám dává klid a jistotu během dovolené
              či služebních cest.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            ...
            <p>
              ...
              úrazu, který může vést k trvalé invaliditě nebo smrti. Tato forma
              pojištění může být užitečná pro ty, kteří vykonávají rizikové
              činnosti, jako je sportovní lezení nebo jízda na motorce.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            <span>
            ...
            <p>
              ...
              nebo dočasné pracovní neschopnosti. Toto pojištění může být
              povinné a zajišťuje, že budete mít přístup k základním finančním
              prostředkům během obtížných období.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            <span>
            ...
            <p>
              ...
              návštěv lékaře, léků a nemocničního pobytu. Toto pojištění je
              klíčové pro zajištění přístupu ke kvalitní zdravotní péči bez
              finanční zátěže.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            ...
            <p>
              ...
              jsou požáry, povodně, krádeže a další škody. To zahrnuje pojištění
              domů, bytů a komerčních nemovitostí.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            <span>
          ...
          <div className="insurance-police-holder-box">
            ...
            <p>
              {insuranceTypes.type12} pokrývá rizika spojená s provozem vozidel.
              To zahrnuje povinné pojištění vozidla a volitelné krytí, jako je
          ...
          <div className="insurance-police-holder-box">
            ...
            <p>
              ...
              odpovědnosti vůči třetím stranám, majetkových škod a dalších
              hrozeb, které by mohly ohrozit podnikání.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            <span>
          ...
          <div className="insurance-police-holder-box">
            ...
            <p>
              ...
              zahrnovat škody na majetku, úrazy a další rizika spojená s
              provozem podniku.
            </p>
          </div>
          <div className="insurance-police-holder-box">
          ...
          <div className="insurance-police-holder-box">
            ...
            <p>
              ...
              Toto pojištění vám může pomoci udržet finanční stabilitu i v
              těžkých časech.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            ...
            <p>
              ...
              právní služby v případě sporů nebo právních žalob. Toto pojištění
              vám může pomoci hájit svá práva.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            <span>
            ...
            <p>
              ...
              prostředků způsobenou různými událostmi, jako jsou podvody,
              krádeže nebo neplacení dlužníkem.
            </p>
          </div>
          <div className="insurance-police-holder-box">
            <span>
            ...
            <p>
              ...
              která vznikne, když vaši dlužníci neplatí své dluhy. Toto
